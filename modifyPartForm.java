...
public class modifyPartForm implements Initializable {
    /** buttons for modify part table view. */
    @FXML Button save;
    @FXML Button cancel;
    @FXML
    ...
    /** test fields for  modify table view */
    ...
    /** InHouse radio button method. That set the Label to Machine ID */
    public void onInHouse(ActionEvent actionEvent) {
        ...
        /** OutSourced radio button method. That set the label to Company Name */
        }
