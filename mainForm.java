...
public class mainForm implements Initializable {
    ...
    public void onModify(ActionEvent actionEvent) throws IOException {
        ...
        if (!(part_Tableview.getSelectionModel().getSelectedItem() == null)) {
    ...
    public void onProdModify(ActionEvent actionEvent) throws IOException {
        if (!(prod_Tableview.getSelectionModel().getSelectedItem() == null)) {
            FXMLLoader loader = new FXMLLoader();
    ...
    public void onProdSearch(KeyEvent keyEvent) throws IOException {
        try {
            ...
            ObservableList<Product> tableview_List = Inventory.getAllProducts();
            for (Product Pr : tableview_List) {
                if (Pr.getId() == Id ) {
                    items.add(Pr);
                }
            }
            prod_Tableview.setItems(items);
        }
        catch (NumberFormatException e){
            String partialName = prod_Search.getText();
